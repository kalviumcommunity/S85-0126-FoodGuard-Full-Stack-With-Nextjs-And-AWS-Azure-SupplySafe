...
export default function UsersPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'active':
        return <Badge variant="compliant" className="text-xs">Active</Badge>
      case 'inactive':
        return <Badge variant="secondary" className="text-xs">Inactive</Badge>
      case 'suspended':
        return <Badge variant="critical" className="text-xs">Suspended</Badge>
      default:
  ...
  const overallStats = {
    ...
    administrators: usersData.filter(u => u.role.includes('Administrator')).length,
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-600">{overallStats.inactive}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{overallStats.administrators}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-amber-600">{overallStats.inspectors}</p>
                </div>
                ...
                <TableBody>
                  {filteredUsers.map((user) => (
                    <TableRow key={user.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>
                        <div>
                          <div className="text-sm text-gray-900">{user.lastLogin.split(' ')[1]}</div>
                          <div className="text-xs text-gray-500">{user.lastLogin.split(' ')[0]}</div>
                        </div>
                      </TableCell>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-lg font-medium text-gray-900">Rajesh Kumar</p>
                      <p className="text-sm text-gray-600">System Administrator</p>
                      <Badge variant="compliant" className="text-xs mt-1">Active</Badge>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-2 pt-3 border-t border-gray-200">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">rajesh.kumar@ircs.gov.in</span>
                    </div>
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">Mumbai Central Office</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      <Badge variant="secondary" className="text-xs">System Config</Badge>
                    </div>
                  </div>
                </div>
              </div>
