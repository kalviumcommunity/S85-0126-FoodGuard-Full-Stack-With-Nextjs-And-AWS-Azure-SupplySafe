              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Batch BATCH-7845 delivered</p>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Hygiene inspection scheduled</p>
                      <p className="text-xs text-gray-500">Pune Kitchen - 4 hours ago</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Fresh Foods Ltd - 6 hours ago</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Link href="/traceability">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mt-1">Food journey tracking</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/batches">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mt-1">Manage food batches</p>
              </CardContent>
            </Card>
          </Link>
