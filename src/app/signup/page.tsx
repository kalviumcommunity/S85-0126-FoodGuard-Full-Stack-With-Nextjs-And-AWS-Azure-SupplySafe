...
import { Shield, Eye, EyeOff, Check, AlertCircle, ArrowRight, CheckCircle } from "lucide-react";
  ...
  if (showSuccess) {
    return (
      <div style={{
        ...
        background: 'linear-gradient(to bottom right, #dbeafe, white, #dcfce8)'
      }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ marginBottom: '2rem' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', color: '#111827', marginBottom: '1rem' }}>Account Created!</h1>
            <p style={{ fontSize: '20px', color: '#6b7280', marginBottom: '0.5rem' }}>Welcome to SupplySafe</p>
      ...
      <div style={{ 
        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6B7280', marginBottom: '0.5rem' }}>Digital Food Traceability System</p>
            <h1 style={{ fontSize: '28px', fontWeight: 'bold', color: '#111827', marginBottom: '0.75rem' }}>Create your SupplySafe account</h1>
            <p style={{ color: '#6B7280' }}>Join India's railway food safety monitoring network</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {/* Account Type Pills */}
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: '#111827', marginBottom: '12px' }}>Account Type</label>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                {["User", "Supplier", "Administrator"].map((type) => (
                  <button
                    key={type}
                    type="button"
                    onClick={() => setFormData({...formData, accountType: type.toUpperCase()})}
                    style={{
                      padding: '8px 16px',
                      borderRadius: '20px',
                      border: '2px solid',
                      ...
                      fontSize: '14px',
                      fontWeight: '500',
                      backgroundColor: formData.accountType === type.toUpperCase() ? '#0F2A44' : 'white',
                      borderColor: formData.accountType === type.toUpperCase() ? '#0F2A44' : '#D1D5DB',
                      color: formData.accountType === type.toUpperCase() ? 'white' : '#374151',
                      cursor: 'pointer'
                    }}
                    onMouseEnter={(e) => {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  onFocus={(e) => {
                    e.currentTarget.style.borderColor = '#0F2A44';
                    e.currentTarget.style.boxShadow = '0 0 0 3px rgba(15, 42, 68, 0.1)';
                  }}
                  onBlur={(e) => {
                    e.currentTarget.style.borderColor = '#D1D5DB';
            ...
            <button
              ...
              style={{
                width: '100%',
                backgroundColor: (isLoading || isSubmitting) ? '#6b7280' : '#0F2A44',
                color: 'white',
                padding: '12px 24px',
                borderRadius: '12px',
                fontSize: '16px',
              ...
              onMouseEnter={(e) => {
                if (!isLoading && !isSubmitting) {
                  ...
                  e.currentTarget.style.boxShadow = '0 10px 25px rgba(15, 42, 68, 0.2)';
                }
              }}
              onMouseLeave={(e) => {
                if (!isLoading && !isSubmitting) {
            ...
            {carouselImages.map((image, index) => (
              ...
              >
                ...
                <div style={{
                  ...
                  <p style={{ color: 'white', fontSize: '20px', fontWeight: '500', textAlign: 'center' }}>{image.caption}</p>
                </div>
              </div>
            ))}
          </div>
