...
const alerts = [
  {
    ...
    description: 'Temperature exceeded safe limits for dairy products. Current temp: 12°C (Safe: ≤4°C)',
  ...
  },
  {
    ...
    description: 'Hygiene compliance fell below 80% threshold during routine inspection',
  ...
  },
  {
    ...
    description: 'Food batch QR code could not be verified at transport checkpoint',
...
export default function AlertsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'active':
        return <Badge variant="critical" className="text-xs">Active</Badge>
      case 'resolved':
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Monitor and respond to system alerts in real-time</p>
          </div>
          <Button>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{overallStats.info}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">{overallStats.active}</p>
                </div>
                ...
                <TableBody>
                  {filteredAlerts.map((alert) => (
                    <TableRow key={alert.id} className="hover:bg-gray-50">
                      ...
                      <TableCell className="text-sm text-gray-600">{alert.assignedTo}</TableCell>
                      <TableCell>
                        <div>
                          <div className="text-sm text-gray-900">{alert.timestamp.split(' ')[1]}</div>
                          <div className="text-xs text-gray-500">{alert.timestamp.split(' ')[0]}</div>
                        </div>
                      </TableCell>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Temperature Violation - Storage Unit A3</p>
                      <p className="text-sm text-gray-600">Temperature exceeded safe limits for dairy products. Current temp: 12°C (Safe: ≤4°C)</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-200">
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">IoT Sensor - TEMP-A3-001</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-600">High - Risk of food spoilage affecting 245 meals</p>
                    </div>
                    <div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">Immediate cooling required</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                    <span className="text-sm text-gray-700">Inspect refrigeration unit</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                    <span className="text-sm text-gray-700">Check temperature logs</span>
                  </div>
                </div>
