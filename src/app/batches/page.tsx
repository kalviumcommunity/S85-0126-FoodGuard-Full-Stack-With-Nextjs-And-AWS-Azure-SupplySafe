...
export default function BatchesPage() {
  ...
  const filteredBatches = batchesData.filter((batch) => {
    ...
    const matchesPriority =
      selectedPriority === "all" || batch.priority === selectedPriority;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage and track food batches across the supply chain
            </p>
          </div>
          <Button>
                ...
                <TableBody>
                  {filteredBatches.map((batch) => (
                    <TableRow key={batch.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>
                        <span
                          className={`text-sm font-medium ${getHygieneColor(batch.hygieneScore)}`}
                        >
                          {batch.hygieneScore}%
                        </span>
                      </TableCell>
                      <TableCell>
                        <span
                          className={`text-sm font-medium ${getTemperatureColor(batch.temperature)}`}
                        >
                          {batch.temperature}
                        </span>
                      </TableCell>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">
                  Showing {filteredBatches.length} of {batchesData.length}{" "}
                  batches
                </span>
