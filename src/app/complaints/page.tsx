...
const complaints = [
  {
    ...
    description: 'Complaint about stale food served in Coach A2, Seat 45. Food was cold and seemed to be from previous day.',
  ...
  },
  {
    ...
    description: 'Report of unhygienic food preparation area. Staff not wearing proper hair nets and gloves.',
  ...
  },
  {
    ...
    description: 'Delayed food service during journey. Food served 2 hours after scheduled time.',
  ...
  },
  {
    ...
    description: 'Complaint about small food portions. Regular meal size reduced significantly.',
  ...
  },
  {
    ...
    description: 'Charged extra for vegetarian meal despite having valid ticket.',
  ...
  },
  {
    ...
    description: 'Catering staff was rude and unresponsive to passenger requests.',
...
export default function ComplaintsPage() {
  ...
  const getSeverityBadge = (severity: string) => {
    switch (severity) {
      case 'high':
        return <Badge variant="critical" className="text-xs">High</Badge>
      case 'medium':
        return <Badge variant="pending" className="text-xs">Medium</Badge>
      case 'low':
        return <Badge variant="outline" className="text-xs">Low</Badge>
      default:
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Track and resolve passenger complaints efficiently</p>
          </div>
          <Button>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">{overallStats.open}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-amber-600">{overallStats.investigating}</p>
                </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Complaint Records ({filteredComplaints.length})</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {filteredComplaints.map((complaint) => (
                    <TableRow key={complaint.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>
                        <div>
                          <div className="text-sm font-medium text-gray-900">{complaint.passenger}</div>
                          <div className="text-xs text-gray-500">{complaint.contact}</div>
                        </div>
                      </TableCell>
                      <TableCell className="text-sm text-gray-600">{complaint.train}</TableCell>
                      <TableCell>
                        <div>
                      ...
                      <TableCell className="text-sm text-gray-600">{complaint.assignedTo}</TableCell>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Button variant="outline" size="sm" disabled className="text-gray-700 border-gray-300 hover:bg-gray-50">
                    Previous
                  </Button>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-900">Complaint Information</h4>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-5 h-5 text-red-600 mt-0.5" />
                    <div>
                      <p className="text-sm font-medium text-gray-900">Hygiene concern - Mumbai Central Kitchen</p>
                      <p className="text-sm text-gray-600">Report of unhygienic food preparation area. Staff not wearing proper hair nets and gloves.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-200">
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">Anonymous Staff</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">2024-01-27 10:15 AM</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500">Location</p>
                      <p className="text-sm text-gray-900">Mumbai Central Kitchen</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-red-900">Immediate Action Required</span>
                    </div>
                    <p className="text-xs text-red-700">Critical hygiene violation that could affect food safety and passenger health.</p>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-600" />
                      <span className="text-sm text-gray-700">Immediate inspection scheduled</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Clock className="w-4 h-4 text-amber-600" />
                      <span className="text-sm text-gray-700">Staff training required</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <FileText className="w-4 h-4 text-blue-600" />
                      <span className="text-sm text-gray-700">Report to be filed with FSSAI</span>
                    </div>
                  </div>
