...
import { ProtectedComponent, usePermissions, PermissionButton } from '@/components/rbac/ProtectedComponent';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          {user ? (
            ...
            <div className="space-y-4">
              <p className="text-gray-600">Not logged in. Test with different roles:</p>
        ...
        {user && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4">UI Components with Role-Based Access</h2>
            ...
            <div className="space-y-4">
              ...
              <ProtectedComponent requiredPermission="read" resource="dashboard">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {logs.length > 0 ? (
            ...
            <p className="text-gray-600">No access attempts yet. Try the permission tests above.</p>
          )}
        </div>

        {/* Role Permissions Reference */}
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          <h2 className="text-xl font-semibold mb-4">Role Permissions Reference</h2>
