    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Food Traceability Flow</h2>
            <p className="text-gray-600 mt-1">Complete journey from supplier to passenger</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between relative">
          ...
          {traceabilitySteps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="flex flex-col items-center space-y-4 z-10">
                {/* Icon and Status */}
        ...
        {traceabilitySteps.map((step) => {
          ...
          return (
            <Card key={step.id} className={`${
              ...
              step.status === 'in-progress' ? 'border-amber-200 bg-amber-50' :
              'border-gray-200'
            }`}>
                ...
                <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className={`text-sm font-semibold ${getTemperatureColor(step.details.temperature)}`}>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className={`text-sm font-semibold ${
                        step.details.hygieneScore >= 90 ? 'text-green-600' :
                        step.details.hygieneScore >= 80 ? 'text-amber-600' :
                        'text-red-600'
                      }`}>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className={`text-sm font-semibold ${
                        step.details.qrVerified ? 'text-green-600' : 'text-red-600'
                      }`}>
