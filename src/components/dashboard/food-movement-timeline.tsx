              ...
              <div key={step.id} className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge variant={
                      isCompleted ? 'compliant' :
                      isInProgress ? 'pending' :
                      'default'
                    }>
                      {step.status}
                    </Badge>
                  ...
                  <div className="space-y-1 text-xs text-gray-600">
                    ...
                    <p><span className="font-medium">Time:</span> {step.time}</p>
                    <p><span className="font-medium">Responsible:</span> {step.responsible}</p>
                    
                    <div className="flex items-center space-x-4 pt-1">
                      <div className="flex items-center space-x-1">
                        <span className="font-medium">Hygiene:</span>
                        <Badge variant={
                          step.hygiene === 'compliant' ? 'compliant' :
                          step.hygiene === 'pending' ? 'pending' :
                          'critical'
                        } className="text-xs">
                          {step.hygiene}
                        </Badge>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <Badge variant={
                          step.qr === 'verified' ? 'compliant' :
                          step.qr === 'pending' ? 'pending' :
                          'critical'
                        } className="text-xs">
                          {step.qr}
                        </Badge>
